...
//alert('clicked slide settings');
    $('#settings_panel').toggle('slide', {direction: 'right'}, 200, function () {
       ...
       // var gridwidth = $('#searchResults').jqxGrid('width');
       // $('#searchResults').jqxGrid('width', gridwidth == '101%' ? "70%" : "101%");
    });
...
function applyDisplayNFreezeCriteria() {

    //display1VENDOR_NAME
    //display2createDate
    //display3matlGroup
    //display4STRIP_REFERENCE_NO



    $("#personalize_tbl tr").each(function () {

        if ($(this).find("td:eq(0)").attr('class') != 'criteria_headers')
        {
            $(this).children("td").each(function () {
                if ($(this).find(':input').attr('data-type') == 'display') {
                    if ($(this).find(':input').prop('checked')) {
                        $('#searchResults').jqxGrid('showcolumn', $(this).find(':input').attr('data-col-name'));
                    }
                    else {
                        $('#searchResults').jqxGrid('hidecolumn', $(this).find(':input').attr('data-col-name'));
                    }
                }
                else if ($(this).find(':input').attr('data-type') == 'freeze') {
                    if ($(this).find(':input').prop('checked')) {
                        $('#searchResults').jqxGrid('pincolumn', $(this).find(':input').attr('data-col-name'));
                    }
                    else {
                        $('#searchResults').jqxGrid('unpincolumn', $(this).find(':input').attr('data-col-name'));
                    }
                }
...
//
//
//    $('#searchResults').jqxGrid('showcolumn', 'columndatafield');
//    $('#searchResults').jqxGrid('hidecolumn', 'columndatafield');
//
//    if ($("#display2VENDOR_NAME").prop('checked'))
//    {
//        $('#searchResults').jqxGrid('showcolumn', 'vendorName');
//
//
//    }
//    else {
//        $('#searchResults').jqxGrid('hidecolumn', 'vendorName');
//    }
//    if ($("#display3createDate").prop('checked'))
//    {
//        $('#searchResults').jqxGrid('showcolumn', 'createDate');
//    }
//    else {
//        $('#searchResults').jqxGrid('hidecolumn', 'columndatafield');
//    }
//    if ($("#display4matlGroup").prop('checked'))
//    {
//        $('#searchResults').jqxGrid('showcolumn', 'matlGroup');
//    }
//    else {
//        $('#searchResults').jqxGrid('hidecolumn', 'matlGroup');
//    }
//
//    if ($("#display5REFERENCE_TYPE").prop('checked'))
//    {
//        $('#searchResults').jqxGrid('showcolumn', 'referenceType');
//    }
//    else {
//        $('#searchResults').jqxGrid('hidecolumn', 'referenceType');
//    }
//
//
//
...
//    //freeze2createDate
//    //freeze3matlGroup
//    //freeze4STRIP_REFERENCE_NO
//    if ($("#freeze1STRIP_REFERENCE_NO").prop('checked'))
//    {
//        $('#searchResults').jqxGrid('pincolumn', 'stripReferenceNo');
//        // alert('freezing;;;');
//    }
//    else {
//        $('#searchResults').jqxGrid('unpincolumn', 'stripReferenceNo');
//    }
//
//    if ($("#freeze2VENDOR_NAME").prop('checked'))
//    {
//        $('#searchResults').jqxGrid('pincolumn', 'vendorName');
//        // alert('freezing;;;');
//    }
//    else {
//        $('#searchResults').jqxGrid('unpincolumn', 'vendorName');
//    }
//    if ($("#freeze3createDate").prop('checked'))
//    {
//        $('#searchResults').jqxGrid('pincolumn', 'createDate');
//    }
//    else {
//        $('#searchResults').jqxGrid('unpincolumn', 'createDate');
//    }
//    if ($("#freeze4matlGroup").prop('checked'))
//    {
//        $('#searchResults').jqxGrid('pincolumn', 'matlGroup');
//    }
//    else {
//        $('#searchResults').jqxGrid('pincolumn', 'matlGroup');
//    }

    $('#searchResults').jqxGrid('updatebounddata');
    $('#searchResults').jqxGrid('refresh');
...
//}
    ...
    var tb_freeze_criteria = "<tr  id='confirm_display'><td colspan=4 style='text-align:center'><input type='button' class='applyChanges' value='Apply Changes' onclick='applyDisplayNFreezeCriteria();'></td></tr><tr>"
    ...
    for (var i = 1; i < jsDisplay_len; i++)
    {
        if (i % 2 == 0)
        {
            ...
            tb_display_criteria = tb_display_criteria
                    ...
                    + " data-type='display' data-col-name='" + jsDisplayArray[i].J_CNAM.toString().trim() + "'"
                    // +"id='status_search'"
...
//
    ...
    for (var i = 1; i < jsFreezelen; i++)
    {
        ...
        if (i % 2 == 0)
        {
            ...
            tb_freeze_criteria = tb_freeze_criteria
                    ...
                    // +"id='status_search'"
                    + " data-type='freeze' data-col-name='" + jsFreezeArray[i].J_CNAM.toString().trim() + "'"
    ...
    table_personalize = table_personalize
            + "<tr id='confirm_freeze' ><td colspan=4 style='text-align:center'><input type='button' class='applyChanges' value='Apply Changes' onclick='applyDisplayNFreezeCriteria();'></td></tr><tr>"
            + "</tbody</table>";
